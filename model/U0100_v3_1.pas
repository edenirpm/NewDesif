...
procedure T0100_v3_1.SetCod_Trib_DES_IF(const Value: integer);
begin
  FCod_Trib_DES_IF := Value;
end;

procedure T0100_v3_1.SetConta(const Value: string);
begin
  FConta := Value;
end;

procedure T0100_v3_1.SetConta_COSIF(const Value: integer);
begin
  FConta_COSIF := Value;
end;

procedure T0100_v3_1.SetConta_Supe(const Value: string);
begin
  FConta_Supe := Value;
end;

procedure T0100_v3_1.SetDesc_Conta(const Value: string);
begin
  FDesc_Conta := Value;
end;

procedure T0100_v3_1.SetNome(const Value: string);
begin
  FNome := Value;
end;

procedure T0100_v3_1.SetNum_Linha(const Value: integer);
begin
  FNum_Linha := Value;
end;

procedure T0100_v3_1.SetReg(const Value: integer);
begin
  FReg := Value;
end;
