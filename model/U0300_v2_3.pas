...
procedure T0300_v2_3.SetDesc_Compl_Serv_Remn_Varl(const Value: string);
begin
  FDesc_Compl_Serv_Remn_Varl := Value;
end;

procedure T0300_v2_3.SetIdto_Serv_Remn_Varl(const Value: integer);
begin
  FIdto_Serv_Remn_Varl := Value;
end;

procedure T0300_v2_3.SetNum_Linha(const Value: integer);
begin
  FNum_Linha := Value;
end;

procedure T0300_v2_3.SetReg(const Value: integer);
begin
  FReg := Value;
end;

procedure T0300_v2_3.SetSub_Titu(const Value: string);
begin
  FSub_Titu := Value;
end;
