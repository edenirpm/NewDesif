...
T0440_v2_3=class
  private
    ...
    FOrig_Cred_A_Cmpn_v_2_3: TOrig_Cred_A_Cmpn_v_2_3;
    FDesc_Dedu: string;
    ...
    procedure SetOrig_Cred_A_Cmpn_v_2_3(const Value: TOrig_Cred_A_Cmpn_v_2_3);
  ...
  property  Orig_Cred_A_Cmpn:TOrig_Cred_A_Cmpn_v_2_3 read FOrig_Cred_A_Cmpn_v_2_3 write SetOrig_Cred_A_Cmpn_v_2_3;
...
{ TOrig_Cred_A_Cmpn_v_2_3 }

procedure TOrig_Cred_A_Cmpn_v_2_3.SetCmpe_Orig_Cred(const Value: string);
begin

end;

procedure TOrig_Cred_A_Cmpn_v_2_3.SetValr_Orig_Cred(const Value: currency);
begin
...
procedure T0440_v2_3.SetAliq_ISSQN(const Value: double);
begin
  FAliq_ISSQN := Value;
end;

procedure T0440_v2_3.SetBase_Calc(const Value: currency);
begin
  FBase_Calc := Value;
end;

procedure T0440_v2_3.SetCNPJ(const Value: integer);
begin
  FCNPJ := Value;
end;

procedure T0440_v2_3.SetCod_Trib_DES_IF(const Value: integer);
begin
  FCod_Trib_DES_IF := Value;
end;

procedure T0440_v2_3.SetDedu_Rece_Decl_Cnso(const Value: currency);
begin
  FDedu_Rece_Decl_Cnso := Value;
end;

procedure T0440_v2_3.SetDedu_Rece_Decl_Sub_Titu(const Value: currency);
begin
  FDedu_Rece_Decl_Sub_Titu := Value;
end;

procedure T0440_v2_3.SetDesc_Dedu(const Value: string);
begin
  FDesc_Dedu := Value;
end;

procedure T0440_v2_3.SetDesc_Inct_Fisc(const Value: string);
begin
  FDesc_Inct_Fisc := Value;
end;

procedure T0440_v2_3.SetInct_Fisc(const Value: currency);
begin
  FInct_Fisc := Value;
end;

procedure T0440_v2_3.SetInct_Fisc_Sub_Titu(const Value: currency);
begin
  FInct_Fisc_Sub_Titu := Value;
end;

procedure T0440_v2_3.SetISSQN_A_Relh(const Value: currency);
begin
  FISSQN_A_Relh := Value;
end;

procedure T0440_v2_3.SetMotv_Nao_Exig(const Value: integer);
begin
  FMotv_Nao_Exig := Value;
end;

procedure T0440_v2_3.SetNum_Linha(const Value: integer);
begin
  FNum_Linha := Value;
end;

procedure T0440_v2_3.SetOrig_Cred_A_Cmpn_v_2_3(
  const Value: TOrig_Cred_A_Cmpn_v_2_3);
begin
  FOrig_Cred_A_Cmpn_v_2_3 := Value;
end;

procedure T0440_v2_3.SetProc_Motv_Nao_Exig(const Value: string);
begin
  FProc_Motv_Nao_Exig := Value;
end;

procedure T0440_v2_3.SetRece_Decl_Cnso(const Value: currency);
begin
  FRece_Decl_Cnso := Value;
end;

procedure T0440_v2_3.SetReg(const Value: integer);
begin
  FReg := Value;
end;

procedure T0440_v2_3.SetValr_A_Cmpn(const Value: currency);
begin
  FValr_A_Cmpn := Value;
end;

procedure T0440_v2_3.SetValr_ISSQN_Devd(const Value: currency);
begin
  FValr_ISSQN_Devd := Value;
end;

procedure T0440_v2_3.SetValr_ISSQN_Rclh(const Value: currency);
begin
  FValr_ISSQN_Rclh := Value;
end;

procedure T0440_v2_3.SetValr_ISSQN_Retd(const Value: currency);
begin
