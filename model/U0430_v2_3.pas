...
procedure T0430_v2_3.SetAliq_ISSQN(const Value: double);
begin
  FAliq_ISSQN := Value;
end;

procedure T0430_v2_3.SetBase_Calc(const Value: currency);
begin
  FBase_Calc := Value;
end;

procedure T0430_v2_3.SetCod_Depe(const Value: string);
begin
  FCod_Depe := Value;
end;

procedure T0430_v2_3.SetCod_Trib_DES_IF(const Value: integer);
begin
  FCod_Trib_DES_IF := Value;
end;

procedure T0430_v2_3.SetDedu_Rece_Dec(const Value: currency);
begin
  FDedu_Rece_Dec := Value;
end;

procedure T0430_v2_3.SetDesc_Dedu(const Value: string);
begin
  FDesc_Dedu := Value;
end;

procedure T0430_v2_3.SetDesc_Inct_Fisc(const Value: string);
begin
  FDesc_Inct_Fisc := Value;
end;

procedure T0430_v2_3.SetInct_Fisc(const Value: currency);
begin
  FInct_Fisc := Value;
end;

procedure T0430_v2_3.SetMotv_Nao_Exig(const Value: integer);
begin
  FMotv_Nao_Exig := Value;
end;

procedure T0430_v2_3.SetNum_Linha(const Value: integer);
begin
  FNum_Linha := Value;
end;

procedure T0430_v2_3.SetProc_Motv_Nao_Exig(const Value: string);
begin
  FProc_Motv_Nao_Exig := Value;
end;

procedure T0430_v2_3.SetRece_Decl(const Value: currency);
begin
  FRece_Decl := Value;
end;

procedure T0430_v2_3.SetReg(const Value: integer);
begin
  FReg := Value;
end;

procedure T0430_v2_3.SetSub_Titu(const Value: string);
begin
  FSub_Titu := Value;
end;

procedure T0430_v2_3.SetValr_Cred_Mens(const Value: currency);
begin
  FValr_Cred_Mens := Value;
end;

procedure T0430_v2_3.SetValr_Debt_Mens(const Value: currency);
begin
  FValr_Debt_Mens := Value;
end;

procedure T0430_v2_3.SetValr_ISSQN_Retd(const Value: currency);
begin
