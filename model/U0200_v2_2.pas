...
procedure T0200_v2_3.SetDesc_Tari(const Value: string);
begin
  FDesc_Tari := Value;
end;

procedure T0200_v2_3.SetIdto_Tari(const Value: string);
begin
  FIdto_Tari := Value;
end;

procedure T0200_v2_3.SetNum_Linha(const Value: integer);
begin
  FNum_Linha := Value;
end;

procedure T0200_v2_3.SetReg(const Value: integer);
begin
  FReg := Value;
end;

procedure T0200_v2_3.SetSub_Titu(const Value: string);
begin
  FSub_Titu := Value;
end;
