...
procedure T0400_v2_3.SetCnpj_Proprio(const Value: integer);
begin
  FCnpj_Proprio := Value;
end;

procedure T0400_v2_3.SetCnpj_Unif(const Value: integer);
begin
  FCnpj_Unif := Value;
end;

procedure T0400_v2_3.SetCod_Depe(const Value: string);
begin
  FCod_Depe := Value;
end;

procedure T0400_v2_3.SetCod_Munc(const Value: integer);
begin
  FCod_Munc := Value;
end;

procedure T0400_v2_3.SetCtbl_Propria(const Value: string);
begin
  FCtbl_Propria := Value;
end;

procedure T0400_v2_3.SetDat_Fim_Para(const Value: string);
begin
  FDat_Fim_Para := Value;
end;

procedure T0400_v2_3.SetDat_Inic_Para(const Value: string);
begin
  FDat_Inic_Para := Value;
end;

procedure T0400_v2_3.SetEndr_Depe(const Value: string);
begin
  FEndr_Depe := Value;
end;

procedure T0400_v2_3.SetIndr_insc_Muni(const Value: string);
begin
  FIndr_insc_Muni := Value;
end;

procedure T0400_v2_3.SetNum_Linha(const Value: integer);
begin
  FNum_Linha := Value;
end;

procedure T0400_v2_3.SetReg(const Value: integer);
begin
  FReg := Value;
end;

procedure T0400_v2_3.SetTipo_Depe(const Value: integer);
begin
  FTipo_Depe := Value;
end;
