...
procedure T0000.SetAno_Mes_Fim_Comp(const Value: string);
begin
  FAno_Mes_Fim_Comp := Value;
end;

procedure T0000.SetAno_Mes_Inic_Compe(const Value: string);
begin
  FAno_Mes_Inic_Compe := Value;
end;

procedure T0000.SetCnpj(const Value: integer);
begin
  FCnpj := Value;
end;

procedure T0000.SetCod_Munc(const Value: integer);
begin
  FCod_Munc := Value;
end;

procedure T0000.SetNome(const Value: string);
begin
  FNome := Value;
end;

procedure T0000.SetNumLinha(const Value: integer);
begin
  FNumLinha := Value;
end;

procedure T0000.SetReg(const Value: integer);
begin
  FReg := Value;
end;

procedure T0000.SetTipo_inti(const Value: string);
begin
  FTipo_inti := Value;
end;
